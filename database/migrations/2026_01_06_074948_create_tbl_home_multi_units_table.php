...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_home_multi_units', function (Blueprint $table) {
            $table->bigIncrements('id')->index('idx_multihomeunit_id');
            $table->integer('user_id')->nullable()->index('idx_multihomeunit_user');
            $table->string('area_unit')->nullable();
            $table->integer('parent_user_id')->nullable();
            $table->string('brochure')->nullable();
            $table->integer('sub_user_id')->nullable()->index('idx_multihomeunit_sub_user');
            $table->integer('show_on_home')->default(0);
            $table->integer('only_for_enquiry')->default(0);
            $table->integer('home_id')->nullable()->index('idx_multi_units_home_id');
            ...
            $table->integer('location_id')->index('idx_multihomeunit_location');
            ...
            $table->integer('ru_property_id')->nullable()->index('idx_multihome_ru_property_id');
            ...
            $table->index(['location_id', 'status', 'ru_property_id'], 'idx_locaaation_aid_statuss');
            $table->index(['is_published', 'status'], 'idx_multihomeunit_status');
            // $table->primary(['id']);
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_home_multi_units');
    }
};
