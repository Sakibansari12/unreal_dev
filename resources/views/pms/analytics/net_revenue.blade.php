                                        ...
                                        <div class="row justify-content-xl-end gy-3 gx-2">
                                            ...
                                            <div class="col-12 col-md-auto">
                                                <div class="btn-group gap-1">
                                                    ...
                                                    <a href="{{ route('pms.analytics.net_revenue', ['days' => request('days')]) }}"
                                        ...
                                        <table class="table table-list-2 align-middle mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($dataList as $data)
                                                    <tr>
                                                        <td nowrap>
                                                            <b><i class="bi bi-calendar2-check"></i>
                                                                {{ \Carbon\Carbon::parse($data->checkin_date)->format('d M, Y') }}</b>
                                                        </td>
                                                        ...
                                                        <td class="text-end">
                                                            <b
                                                                class="text-black">₹{{ number_format($data->revenue, 2) }}</b>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
