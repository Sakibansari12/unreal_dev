                                    ...
                                    <div class="col-auto position-relative">
                                        <div class="row justify-content-xl-end gy-3 gx-2">
                                            <div class="col-12 col-lg col-xl-auto">
                                                <div class="row gy-3 gx-2">
                                                    <div class="col">
                                                        <input type="date" class="form-control flatpickr" name="from-date"
                        ...
                        <div class="col-auto">
                            <div class="search-filter">
                                <div class="row gx-2 align-items-center">
                                    ...
                                    {{-- <div class="col-auto position-relative">
                                        <a href="javascript:void(0)" class="btn btn-sm btn-outline-dark filter"><i
                                                class="bi bi-sort-down me-2"></i> Filter </a>
                                    </div> --}}
                                    <!-- FILTER BUTTON -->
<div class="col-auto position-relative">
    <a href="javascript:void(0)" class="btn-sm btn-outline-dark filter filter-btn" onclick="toggleFilter()">
                ...
                <section class="section">
                    <div class="page-content position-relative">
                        <div class="row g-4 chartRow">
                            ...
                            {{-- <div class="col-12 col-xl-4">
                                <a href="{{ route('pms.analytics.bookings_created') }}"
                                    class="card card-chartBox bg-transparent h-100 text-decoration-none">
                                    <div class="card-body p-0">
                                        <div class="row align-items-center m-3">
                                            <div class="col-12">
                                            ...
                                            <div class="col-auto">
                                                <span class="rounded-pill py-1 px-2" id="bookings-created-percentage"><i
                                                        class="bi"></i> 0%</span>
                                            </div>
                                        </div>
                                        <div class="chartBox">
...
<div class="col-12 col-xl-4">
    ...
    <div id="chartSection">
        <a 
            ...
            <div class="card-body p-0">
                ...
                <div class="chartBox">
                    <canvas id="bookingsChart" role="img" width="590" height="160"></canvas>
                </div>
            </div>
        </a>
    </div>
    ...
    <!-- LOCATION FILTER BOX -->
    <div class="filterOption card card-chartBox bg-white text-decoration-none" id="filterOption" style="display: none;">
        <div class="card-body p-0">
            <div class="row align-items-center m-3">
                <div class="col">
                ...
                <div class="col-auto">
                    <a href="javascript:void(0)" id="clearLocation" class="text-primary text-decoration-none fw-bold fs-14">
                    ...
                    <div class="col">
                        <div class="property-filtter-wrap">
                            <div class="input-group position-relative">
                                <input type="text" id="propertyInput" class="form-control" placeholder="Search Property">
                                <ul id="propertySuggestionList" class="list-group position-absolute w-100" style="z-index: 1000; top: 100%; display: none;"></ul>
                            </div>
                            ...
                            <!-- Average Length of Stay / Lead Time -->
                            <div class="col-12 col-xl-4 d-flex">
                                <div class="card card-chartBox bg-transparent w-100">
                                    {{-- <div class="d-flex justify-content-center py-5 average-loading">
                                ...
                                <div class="card card-chartBox bg-transparent w-100">
                                    <div class="card-body p-4">
                                        ...
                                        <div class="channelList mt-4" id="channelList">
                                            <!-- Dynamic channel list will be populated here -->
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function fetchAllData() {
            ...
            if (dates.length === 2) {
                ...
                // Change dropdown to show 'Select days' (value="")
                if (daysSelect) {
                    daysSelect.value = '';
                }
            ...
            axios.post('https://sc.tempsite.in/pms/linechart', params)
                .then(response => {
            ...
            // Fetch Weekly Report
            axios.post('https://sc.tempsite.in/pms/weeklyreport', {
                    ...params,
                    type: 'net'
                })
            ...
            axios.post('https://sc.tempsite.in/pms/channelrevenue', {
                    ...params,
                    type: 'net'
                })
            ...
            // Fetch Average Length of Stay and Lead Time
            axios.post('https://sc.tempsite.in/pms/dashboard', params)
                .then(response => {
                    const data = response.data.data || {};
    ...
    return `${yyyy}-${mm}-${dd}`;
        ...
        // Update Average Length of Stay and Lead Time Card
        ...
        //     try {
        //         const response = await axios.get('http://127.0.0.1:8000/pms/dashboard/location');
        //         if (response.data.status) {
        //             locations = response.data.location;
        //             const locationList = document.getElementById('location-list');
        //             locationList.innerHTML = locations.map(loc => `
        //                 <li>
        //                     <a href="javascript:void(0)" onclick="setLocation(${loc.location_id})" class="${locationID == loc.location_id ? 'active' : ''}">
        //                         ${loc.location_name}
        //                     </a>
        //                 </li>
        //             `).join('');
    ...
    function toggleFilter() {
        ...
        if (filterOption.style.display === 'none') {
            ...
            fetchLocations(); // Fetch locations only once on open
            fetchProperties();
        } else {
    ...
    async function fetchLocations() {
        try {
            const response = await axios.get('https://sc.tempsite.in/pms/dashboard/location');
            if (response.data.status) {
...
async function fetchProperties() {
    try {
        const response = await axios.get('https://sc.tempsite.in/pms/dashboard/property');
        if (response.data.status) {
...
function setLocation(id) {
   locationID = id;
    fetchLocations(); // optional refresh
    fetchProperties(); // 👈 yeh yaha lagana hai
    fetchAllData(); 
}
// Listen for clear button click
document.getElementById('clearLocation').addEventListener('click', function () {
    locationID = null; // Reset the selected location
    fetchLocations();  // Re-render location badges with default styles
    fetchAllData();    // Optional: Refresh chart data if needed
});
...
function selectProperty(id, pType, name) {
    ...
    fetchAllData(); // Call with selected property
}
