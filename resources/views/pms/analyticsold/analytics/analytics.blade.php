                    ...
                    <div class="page-content position-relative">
                        <div class="row g-4 chartRow">
                            <div class="col-12 col-xl-4">
                                <a href="{{ route('pms.analytics.net_revenue') }}"
...
<div class="col-12 col-xl-4">
    ...
    <script>
        ...
        function fetchAllData() {
            ...
            axios.post('http://127.0.0.1:8000/pms/linechart', params)
                .then(response => {
            ...
            // Fetch Weekly Report
            axios.post('http://127.0.0.1:8000/pms/weeklyreport', {
                    ...params,
                    type: 'net'
                })
            ...
            axios.post('http://127.0.0.1:8000/pms/channelrevenue', {
                    ...params,
                    type: 'net'
                })
            ...
            axios.post('http://127.0.0.1:8000/pms/dashboard', params)
                .then(response => {
                    const data = response.data.data || {};
...
async function fetchProperties() {
    try {
        const response = await axios.get('http://127.0.0.1:8000/pms/dashboard/property');
        if (response.data.status) {
