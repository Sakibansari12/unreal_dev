...
<div class="row modalCalendar" id="modalCalendar">
    <div class="search-location-properties mt-4 mb-4" id="search-form">
        <form id="searchFormId">
            ...
            <input type="hidden" id="per_night_price" name="per_night_price" value="{{ $properties->per_night_price }}">
            <input type="hidden" id="base_price" name="base_price" value="{{ $properties->base_price }}">
                    ...
                    <div class="row gx-2 gy-3 g-md-3">
                        <div class="col-12 col-lg-6">
                            <div class="form-field mb-0">
                                ...
                                <input type="email" class="form-control" id="email_address" name="email_address" value="{{ $customerDetail['email'] ?? '' }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-field form-group mb-0">
                                ...
                                <div class="row gx-2">
                                    ...
                                    <div class="col">
                                        <input type="text" class="form-control" id="mobile_number" name="mobile_number" value="{{ $customerDetail['mobile_number'] ?? '' }}" maxlength="13" oninput="this.value = this.value.replace(/(?!^\+)\D/g, '')">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="form-field mb-0">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name" value="{{ $customerDetail['first_name'] ?? '' }}">
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-field mb-0">
                                <label for="last_name">Last Name<span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="last_name" name="last_name" value="{{ $customerDetail['last_name'] ?? '' }}">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            function calculate() {
                                ...
                                @if(count($addons) > 0)
                                    ...
                                    // Ensure addOnDiscountInput exists before accessing its value
                                     addOnDiscount = addOnDiscountInput ? parseFloat(addOnDiscountInput.value) || 0 : 0;
                                @else
                                ...
                                // Validate Add-on Discount only if add-ons exist rrr
