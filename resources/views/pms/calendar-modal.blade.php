<style>
    ...
    .label-radio label p .bi,
    .label-check label p .bi {
        font-size: 16px;
        line-height: 1;
        margin-right: 2px
    }
    ...
    .label-radio label p strong,
    .label-check label p strong {
        font-size: 11px;
        padding-right: 5px;
        color: #12274a
    }
    ...
    .label-radio input[type=check],
    .label-check input[type=check] {
        display: none
    }

    .label-radio input[type=radio]:checked+label,
    .label-check input[type=radio]:checked+label,
    .label-radio input[type=checkbox]:checked+label,
    .label-check input[type=checkbox]:checked+label,
    .label-radio input[type=check]:checked+label,
    .label-check input[type=check]:checked+label {
        background: #12274a;
        color: #fff;
        background-color: #12274a
    }

    .label-radio input[type=radio]:checked+label h3,
    .label-check input[type=radio]:checked+label h3,
    .label-radio input[type=radio]:checked+label .h3,
    .label-check input[type=radio]:checked+label .h3,
    .label-radio input[type=checkbox]:checked+label h3,
    .label-check input[type=checkbox]:checked+label h3,
    .label-radio input[type=checkbox]:checked+label .h3,
    .label-check input[type=checkbox]:checked+label .h3,
    .label-radio input[type=check]:checked+label h3,
    .label-check input[type=check]:checked+label h3,
    .label-radio input[type=check]:checked+label .h3,
    .label-check input[type=check]:checked+label .h3 {
        color: inherit
    }

    .label-radio input[type=radio]:checked+label p strong,
    .label-check input[type=radio]:checked+label p strong,
    .label-radio input[type=checkbox]:checked+label p strong,
    .label-check input[type=checkbox]:checked+label p strong,
    .label-radio input[type=check]:checked+label p strong,
    .label-check input[type=check]:checked+label p strong {
        color: #fff
    }
    ...
    .label-radio input[type=check]:checked+label:before,
    .label-check input[type=check]:checked+label:before {
        content: "\F26E";
...
<div class="modal-body form-box">
    ...
    <form action="#" id="calendarModalForm" novalidate>
        ...
        <div class="row">
            ...
            <div class="blockProperty d-none resetcls">
                <div class="col-12 col-lg-12 ">
                    <div class="form-field">
                        <label for="">Reason<sup class="text-danger">*</sup></label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary other-submit" onclick="calendarModalFormSubmit()">
