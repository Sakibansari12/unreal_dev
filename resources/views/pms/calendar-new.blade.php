                        ...
                        <div class="col">
                            <form method="get" action="{{ route('pms.calendar') }}">
                                <div class="row g-2">
                                    ...
                                    <div class="col-12 col-lg">
                                        <input type="text" name="guests" class="form-control" placeholder="No. of Guests" value="{{ isset($req['guests']) ? $req['guests'] : '' }}">
                                    </div>
                                    <div class="col-12 col-lg">
                                        <input type="text" name="bedrooms" class="form-control" placeholder="No. of Bedrooms" value="{{ isset($req['bedrooms']) ? $req['bedrooms'] : '' }}">
                                    </div>
...
<script>
    ...
    //     $.ajax({
    //         url: '{{ route("pms.property.booking.save") }}',
    //         type: 'POST',
    //         data: formData,
    //         headers: {
