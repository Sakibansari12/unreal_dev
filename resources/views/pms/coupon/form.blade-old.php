                                    ...
                                    <div class="row g-3 align-items-center">
                                        ...
                                        <div class="col-12 col-lg" id="coupon_code_field">
                                            <input type="text" name="self_code" id="self_code"
                                                placeholder="Code"
                                                value="{{ old('self_code', $detail->coupon_code_self ?? $detail->coupon_code ?? '') }}"
                                            ...
                                            <div class="row gx-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="number" name="no_of_codes" id="no_of_codes"
                                                        ...
                                                        value="{{ old('no_of_codes', $detail->no_of_codes ?? '') }}"
...
fixFlatpickrPlaceholder(stayStartDate);
 ...
 <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Determine if in edit mode based on $detail
            const isEditMode = @json($detail ? true : false);
            // Store original values for discount fields
            ...
            // Store original values for use type and code generation fields
            const originalUseLimit = @json(old('use_limit', $detail->use_limit ?? ''));
            const originalSelfCode = @json(old('self_code', $detail->coupon_code_self ?? $detail->coupon_code ?? ''));
            ...
            function toggleDiscountFields() {
                ...
                console.log('toggleDiscountFields called, percentage checked:', percentageRadio.checked);
            ...
            function toggleCodeGenerationFields() {
                ...
                console.log('toggleCodeGenerationFields called, self checked:', selfRadio.checked);
