            ...
            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;background-color: #ffffff;" class="email-container">
                ...
                <tr>
                    <td style="padding: 20px 20px 10px 20px; font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #444444;">
                        <h2 style="margin:0px 0px 5px 0px; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; color: #333333; font-weight: bold;">Dear {{ ucfirst($customerDetail['first_name'] ?? '') }} {{ ucfirst($customerDetail['last_name'] ?? '') }},</h2>
                        <p style="margin: 0;">Your booking has been canceled. Booking ID: {{ $data->booking_id }}.</p>
                        <p>
                        Please find the booking details below:
                        </p>
                        <p>
                            <strong>Property Name: {{$prorperty->unit_name_website ?? ''}} </strong><br>
                            <strong>Booking Dates: {{$data->checkin_date}} -  {{$data->checkout_date}}</strong><br>  
                            <strong>Total Amount: Rs.{{round($data->payable_amount)}}</strong><br>
                        </p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="background-color: #ffffff;border-bottom: 10px solid #000000;" class="darkmode-bg">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <!--       Dummy Adresss: B-67 birbal road lajpath nagar-->
                            <!--    </td>-->
                            <!--</tr>-->
                            <tr>
