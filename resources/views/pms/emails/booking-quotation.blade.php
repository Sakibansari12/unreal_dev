        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="768" style="margin: auto;background-color: #ffffff;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 0 10px; font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #000000;">
                    <h1 style="margin:0px 0px 5px 0px; font-family: Arial, sans-serif; font-size: 15px; line-height: 30px; color: #333333; font-weight: bold;">Dear {{ ucfirst($data->first_name) }} {{ ucfirst($data->last_name) }},</h1>

                    <p >
                        Welcome to the <strong>Unreal Estate</strong> network of vacation homes.  
                     </p>
                    <p style="margin: 0;">
                        Below is a quotation especially for you, valid for {{ $data->validity ?? '' }} hour. Also subjected to availability when you book.
                    </p>
                    <p>
                        <strong>Do note, we cannot reserve, block, or hold your travel dates till all advance payments are received in full. In case advance payments are being made in parts please ensure that all part payments are made within the due dates to ensure a confirmed stay.</strong>
                    </p>
                    ...
                    <br>
                    <p style="margin: 0;">
                        <a href="{{ $data->url }}" style="color:#1e30d4;font-size:16px;" target="blank"><u>Click Here</u></a>
                    </p>

                    <p>
                        This is an automatic system generated email. For any clarification please call us at +91 99206 64712.
                    </p>
                    <p>
                        Looking forward to hosting you,
                    </p>
                    <p>
                        <strong>Team Unreal Estate</strong>
                    </p>
