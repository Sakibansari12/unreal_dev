        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="768" style="margin: auto;background-color: #ffffff;" class="email-container">
            ...
            <tr>
                <td style="padding: 20px 0 10px; font-family: Arial, sans-serif; font-size: 15px; line-height: 20px; color: #000000;">
                    @if($type == 'customer' || $type == 'booking_manager')
                        ...
                        <p>
                        <strong> We request you to take a minute and put your comments on the website. It would mean a great deal to us.</strong>
                        </p>
                        <p >
                        For your convenience, below is the message left by your group. This can be copied directly on to the site in the link that follows.
                        </p>

                        <p >
                       <strong> "Our stay at {{$data->property->unit_name_website}} property was pleasant and comfortable! The food quality were as per our requirements. We would like to especially thank Shri Subhash and Shri Sanjay for taking care of all our needs and arrange bonfire and BBQ on the night which was very good experience. Overall a very good experience and we hope to return very soon in the future!"</strong>
                        </p>

                        <a href="https://sc.tempsite.in/" style="background-color:#2D2424;border-radius:4px;color:#ffffff;display:inline-block;font-size:13px;font-weight:bold;line-height:34px;text-align:center;text-decoration:none;width:136px;" target="blank">Review</a>
	        ...
	        <tr>
	            <td dir="ltr" width="100%" style="padding: 10px 0px; background-color: #ffffff;">
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td dir="ltr" valign="top" style="padding: 0 0px 20px 0;text-align: center;">

                                @php
                                    $firstImage = $data->property->imagesWebsite->first();
                                    $imageAlt  = $data->property->unit_name_website ?? 'Property Image';
                                @endphp
                                <img class="g-img" src="{{ asset($firstImage->medium_image ?? 'assets/website/images/no-image.png') }}" width="768" height="" alt="{{$data->property->unit_name_website}}" border="0" style="width: 100%; max-width: 768px; background: #dddddd; font-family: Arial, sans-serif; font-size: 15px; line-height: 15px; color: #000000;">
            ...
            <tr>
                <td style="padding: 10px 0px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #000000; text-align: left;">
                    <p >
                    We look forward to hosting you again, along with your family and friends at one of our vacation homes again soon.
                    </p>
                    <p>
                        Happy Holidays!
                    </p>
            ...
            {{-- <tr bgcolor="#252525">
                <td align="center"><img src="{{ asset('assets/images/mail-footer.jpg') }}" style="display: block; width: 100%" width="100%"></td>
            </tr> --}}
            <!--<tr bgcolor="#252525">-->
            ...
            <!--</tr>-->
            {{-- <tr bgcolor="#252525">
                <td height="60" align="center"><img src="{{ asset('assets/images/logo-icon.jpg') }}" style="display: block" width="30"></td>
            </tr> --}}
