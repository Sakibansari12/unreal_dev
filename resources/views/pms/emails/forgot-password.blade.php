        ...
        <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600"
            ...
            <tr>
                <td style="padding: 20px 30px; text-align: center;background-color: #ffffff;">
                    <img src="{{ asset('assets/pms/images/logo.png') }}" width="246" height="57"
                        alt="Unreal Estate" border="0"
                        style="height: auto; font-family: Arial, sans-serif; font-size: 14px; line-height: 15px; color: #000000;">
                </td>
            </tr>
            <!-- Email Header : END -->
                ...
                <td style="background-color: #f1f1f1;border-top:1px solid #d9d9d9" class="darkmode-bg">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td
                                    style="padding: 0px 30px; font-family: Arial, sans-serif; font-size: 15px; line-height: 20px;">
                                    <h2
                                        style="margin:0px 0px 5px 0px; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px;">
                                        Hi ,</h2>
                                    <p style="margin: 0 0 20px;">We received a request to reset the password for your
                                        account.
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    style="padding: 0px 30px; font-family: Arial, sans-serif;  line-height: 20px; font-size: 15px;">
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            <tr>
                                <td
                                    style="padding: 15px 30px; font-family: Arial, sans-serif; line-height: 20px; font-size: 15px;">
                                    <p style="margin: 0 0 20px;">If you didn’t request a password reset, you can safely
                ...
                <td style="background-color: #ffffff;border-bottom: 10px solid #000000;" class="darkmode-bg">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td
                                    style="padding: 10px 30px 30px; font-family: Arial, sans-serif; line-height: 20px; color: #000000;">
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0"
                                        style="width: auto;margin: 0 !important;">
                                        <tbody>
                                            <tr>
                                                <td
                                                    style="font-family: Arial, sans-serif; line-height: 20px; color: #000000;vertical-align: middle;">
                                                    Follow us</td>
                                                <td style="vertical-align: middle;padding-left: 5px;">
                                                    <a href="https://www.linkedin.com/company/unreal-estate1/" target="_blank">
                                                        <img src="{{ asset('assets/pms/images/linkedin.png') }}"
                                                            alt="LinkedIn" width="24" height="24" border="0"
                                                            style="height: auto; font-family: Arial, sans-serif; font-size: 14px; line-height: 15px; display: block; color: #000000;">
                                                    </a>
                                                </td>
                                                <td style="vertical-align: middle;padding-left: 5px;">
                                                    <a href="https://www.instagram.com/_unreal.estate_?igsh=dDh1cnd5dDdranZh&utm_source=qr"
                                                        target="_blank">
                                                        <img src="{{ asset('assets/pms/images/instagram.png') }}"
