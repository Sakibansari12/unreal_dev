        ...
        <div class="form-field">
            ...
            <div class="upload-wrapper text-center" onclick="document.getElementById('imageUpload').click();">
                ...
                <div class="upload-box">
                    ...
                    <small>Minimum 10 images | Max size: 5MB | Min size Dimensions:1024px x 683px , Max size: 3000px x 2000px</small>
                </div>
            </div>
...
<script>
            ...
            const imgHtml = `
                <div class="col-3 mb-3 image-box" data-id="${img.id}" data-position="${img.position}" draggable="true">
                    <div class="position-relative">
                        <img src="${img.image_url}" class="w-100 rounded" style="height:150px; object-fit:cover;">
    ...
    window.addEventListener("load", function () {
        // Jab poora page including images load ho jaye
