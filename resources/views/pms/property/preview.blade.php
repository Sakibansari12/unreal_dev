            ...
            <div class="form-box">
                <div class="row">
                    ...
                    <div class="action-buttons text-end">
                        <button type="button" class="btn d-inline-flex btn-small rounded-2 btn-primary publish-property" @if(!$isPublishBtn) disabled="disabled"  @endif data-value="{{ $detail->id }}">
