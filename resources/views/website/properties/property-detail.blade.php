...
<style>
    ...
    .content {
    max-height: 120px;   /* jitna short dikhana ho */
    overflow: hidden;
    transition: max-height 0.3s ease;
}

.content.expanded {
    max-height: 1000px; /* large value for full content */
}
                    ...
                    <div class="col-6 pt-2">
                        ...
                        <div class="tags">
                            <div class="row g-2">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('property-list', ['tags[]' => $image->id, 'tagName' => $image->tags_name, 'type' => 'tag']) }}" class="card-tag">
...
<section class="section section-checkin-info pt-0">
    <div class="container">
        <h3>{{ isset($property->unit_subtitle_website) ? $property->unit_subtitle_website : '' }}</h3>
            ...
            <div class="col-12 col-lg-6">
                <div class="card-info card-about">
                    ...
                    <div class="content-wrapper">
                        <div class="content" id="propertyDescription">
                            {!! isset($property->description) ? $property->description : '' !!}
                        </div>

                        <a href="javascript:void(0)" id="viewMoreBtn" class="view-more text-decoration-none">
                            View More
                        </a>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        const content = document.getElementById('propertyDescription');
        const btn = document.getElementById('viewMoreBtn');

        // agar content chhota hai to button hide
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAT05jg6bI9JClVoFIA0dYGKSxQUjVCAkk&callback=initMap"></script>
@endsection