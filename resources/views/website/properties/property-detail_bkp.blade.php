...
<div class="page-wrapper">
            ...
            <div class="row g-equal-detail">
                <div class="col-12 col-lg-6">
                    <div class="gallery-card">
                        ...
                        @endif
                        <div class="gallery-icons d-flex gap-4 my-2">
                         @if(!empty($property->propertyVideo) && !empty($property->propertyVideo->filename))
                            <a href="{{ asset('storage/home/video/' .$property->propertyVideo->filename) }}" data-fancybox class="btn">
    ...
    <section class="section swiper-property-image section-mobile-gallery pt-0 pb-4 mt-n2 d-md-none">
        <div class="container-fluid px-0">
            <div class="gallery-icons d-flex gap-4 my-2">
                <a href="./assets/website/images/video.mp4" data-fancybox class="btn">
                    <div class="icon-video">
                        <span class="icon-play"></span>
                    </div>
                </a>
        ...
        <div class="container-fluid">
            <div class="row gx-5 gy-4">
                <div class="col-12 col-xl-8">
                    <h1 class="fs-1 mb-3">{{ $property->unit_name ?? '' }}</h1>
                    ...
                    <ul class="list-unstyled row g-2 share-links justify-content-lg-end justify-content-md-start mb-0">
                        ...
                        <li class="col-auto align-self-center">
                            <a href="#review" class="gallery-card property-reviews">
                                {{ count($property->homeReviews)}} Reviews
                            </a>
                        </li>
                        @endif
                        {{-- <li class="col-auto">
                    ...
                    <div class="main-search-outer detail-page-search ms-0 property-page-checkout">
                        ...
                        <div class="main-search p-0">
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-12">
                                    <button class="btn w-100 offers-btn" data-fancybox data-src="#offer-fancy" data-src="#coupon" data-custom-fancy id="coupon-href">Check offers and discounts</button>
                                </div>
                                                ...
                                                <div class="form-group cs-input bottom-toolbar">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col text-end">
                                                            ...
                                                            <button type="submit" class="btn btn-primary w-md-100 apply_coupon" disabled>Apply <span class="d-none d-md-block"><i class="bi icon-chevron-right"></i></span></button> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="table-subtotal">
                                        <table class="table table-sm mb-0 table-borderless">
                                            <tr class="fw-bold first-tr">
                                                <td>Subtotal - <span class="totalNight"></span> <span class="ntext">nights</span></td>
                                ...
                                {{-- <div class="col-12 mt-0">
                                    <div class="checkout-details">
                                        <a href="#" class="note-link" id="seeDetailsBtn">See Details</a>
                                        <i class="icon-angle-down"></i>
                                    </div>
                                    <table class="table" id="checkoutTable" style="display:none;">
                                        <tr>
                                ...
                                <div class="col-12">
                                    <form action="{{ route('property-book') }}" method="GET">  
                                       <button type="submit" class="btn py-3 fw-bold w-100 btn-primary rounded text-white mt-3 payNowcreate" >
                                          Book Now &nbsp;&nbsp;<span id="spinner_new_form" class="spinner-border spinner-border-sm " style="color: #fff; display: none;" role="status"  aria-hidden="true" ></span>
                                        </button>
                                    </form>
                                    {{-- <button type="submit" class="btn py-3 fw-bold w-100 btn-primary rounded">Book Now</button> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-12">
                                <div class="iconBox">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Our teams are available 24/7 to promptly address customer complaints and ensure swift resolution.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="iconBox">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Properties managed by trained hospitality experts to deliver the best experience.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="iconBox">
                                    ...
                                    <div class="content">
                                        <h3>Best Features</h3>
                                        <p>Enjoy 24/7 caretakers, housekeeping, free Wi-Fi, kitchen, swimming pool, home-cooked meals, and more.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    window.initMap = function(){
        const location = { lat: {{$property->map_latitude ?? '0' }}, lng: {{$property->map_longitude?? '0' }} }; 
...
<script>
    let galleryImages = {        
        all: [
            @foreach($property->imagesWebsite as $image)
                {
                    src: "{{ asset($image->medium_image ?? 'assets/website/images/no-image.png') }}"
                }@if (!$loop->last),@endif
            @endforeach
        ]
    }
